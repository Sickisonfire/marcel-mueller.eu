...
const projects = [
  {
    id: 1,
    title: 'Trello clone',
    description: 'Simple todolist application like Trello.',
    tags: 'react,tailwind,strapi',
    projectUrl: 'https://www.marcel-mueller.eu',
    github: 'https://www.github.com',
    image: 'trello-clone.jpg',
    imageAlt: 'picture of the Trello clone',
  },
]
    ...
    <div tw='w-full flex justify-between border-b-8 pb-5 justify-between sm:(border-l-8 border-b-0 h-52 pl-8) border-orange-500 text-sm text-white'>
      <div tw='flex h-full justify-center flex-col'>
        ...
        <p tw='mb-4 mr-12 whitespace-normal'>
          I am always working on things, so stay tuned. If you want you can checkout my codepen in
          the meanwhile.
        </p>
