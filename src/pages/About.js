  ...
  return (
    ...
    >
      ...
      <p tw='text-white mb-20 '>
        Comming from an engineering background i had plenty experience working with different kinds
        of user interfaces. From teaching a robot to move to programming the path a
        computer-controlled mill has to take to efficiently take off the material or creating 3D
        models with CAD software. Interfaces gave me the possibility to interact with technology and
        create things i could’ve never created without them. <br />
